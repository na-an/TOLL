...
#include "UaOutletFvPatchVectorField.H"
#include "volFields.H"
...
Foam::UaOutletFvPatchVectorField::
UaOutletFvPatchVectorField
(
    const fvPatch& p,
...
UaOutletFvPatchVectorField
(
    const UaOutletFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
UaOutletFvPatchVectorField
(
    const UaOutletFvPatchVectorField& pivpvf,
    const DimensionedField<vector, volMesh>& iF
)
:
...
void Foam::UaOutletFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
	...
	vectorField Uap_t = (nup.value()*deltainv*Uaneigh_t) / (Up_ns+nup.value()*deltainv) ;
...
void Foam::UaOutletFvPatchVectorField::write(Ostream& os) const
{
