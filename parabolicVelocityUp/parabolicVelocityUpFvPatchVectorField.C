...
#include "parabolicVelocityUpFvPatchVectorField.H"
...
parabolicVelocityUpFvPatchVectorField
(
    const parabolicVelocityUpFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::parabolicVelocityUpFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::parabolicVelocityUpFvPatchVectorField::write
(
    Ostream& os
) const
{
